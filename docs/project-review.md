...
> ⚠️ **历史快照**：本文件是 **2026-04-27** 时点的 review 快照，**不是当前项目状态**。
> 当前进度请看 [`collaboration.md`](collaboration.md) 第 4/5 节，或 [`../README.md`](../README.md) §9。
> 本文中"当前更值得补的是推荐算法、统计大屏、演示数据"已不再适用：推荐算法已取消，统计大屏与敏感词过滤、商品/评论审核都已落地。
