...
| 2026-05-02 | `creator_role_revoke_admin_menu_20260502.sql` | 撤销 creator 角色"创作者管理"管理员菜单（修复越权可改/审核别人档案） | `sys_role_menu` |
| 2026-05-02 | `creator_role_data_scope_20260502.sql`        | 撤销 creator 角色"分类管理"（配合后端 `@CreativeDataScope` 给作品/评论按 creatorId 自动过滤） | `sys_role_menu` |
