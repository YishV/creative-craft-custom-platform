-- ============================================================
-- 01 框架基础（RuoYi 系统表 + 初始化数据）
-- 来源: install/01_framework_base.sql
-- ============================================================
...
-- 初始化-部门表数据
-- ----------------------------
-- 文创平台仅用两个部门承接所有用户：买家(200) / 卖家(201)
-- 由 04_system_menus.sql 创建，避免重复
...
-- 初始化-用户信息表数据
-- ----------------------------
insert into sys_user values(1,  200, 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), sysdate(), 'admin', sysdate(), '', null, '管理员');
insert into sys_user values(2,  200, 'ry',    '若依', '00', 'ry@qq.com',  '15666666666', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), sysdate(), 'admin', sysdate(), '', null, '测试员');
...
-- 买家角色 (role_id=100, role_key='buyer') 由 04_system_menus.sql 创建，避免与之重复
...
insert into sys_menu values('4', '项目说明', '0', '4', 'about', null, '', '', 1, 1, 'M', '0', '0', '', 'documentation',    'admin', sysdate(), '', null, '项目说明菜单，默认隐藏');
-- 二级菜单
...
-- 初始化-公告信息表数据
-- ----------------------------
insert into sys_notice values('1', '文创平台演示提示', '2', '请按 注册登录 -> 浏览商品 -> 加入购物车 -> 结算支付 -> 订单中心 的顺序演示买家流程。', '0', 'admin', sysdate(), '', null, '管理员');
insert into sys_notice values('2', '创作者演示提示', '1', '创作者可维护档案、发布商品、查看需求并提交报价，报价被买家选中后进入订单制作流程。',   '0', 'admin', sysdate(), '', null, '管理员');
insert into sys_notice values('3', '文创平台演示说明', '1', '<p>文创手作定制交易平台用于毕业设计演示，核心流程包括用户注册登录、商品浏览、定制需求发布、报价沟通、购物车结算、模拟支付、订单流转、社区作品与收藏关注。</p>', '0', 'admin', sysdate(), '', null, '管理员');
...
-- Source: register_enable_20260427.sql
