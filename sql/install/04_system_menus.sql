...
-- 创建卖家角色
INSERT IGNORE INTO sys_role (role_id, role_name, role_key, role_sort, data_scope, status, del_flag, create_by, create_time)
VALUES (101, '创作者/卖家', 'seller', 3, '1', '0', '0', 'admin', sysdate());
...
(100, 2000), (100, 2010), (100, 2004), (100, 2006), (100, 2009);

-- 卖家：首页、消息、创作者管理、商品管理、报价、作品、评论
INSERT INTO sys_role_menu (role_id, menu_id) VALUES 
(101, 2000), (101, 2010), (101, 2001), (101, 2003), (101, 2005), (101, 2007), (101, 2008);
