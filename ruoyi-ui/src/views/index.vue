  ...
  <div class="app-container home">
    <el-row :gutter="20">
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        <h2>文创手作定制交易平台</h2>
        <p>
          本项目用于承载毕业设计“基于SpringBoot的文创手作定制交易平台设计与实现”。当前版本已完成注册登录、买家与创作者身份区分、商品浏览、定制需求、报价沟通、订单流转、作品分享、评论互动、收藏关注等核心模块，后续可继续扩展购物车、模拟支付、推荐算法与数据统计能力。
        </p>
        <p>
          <b>当前版本:</b> <span>v{{ version }}</span>
        </p>
        <p>
          <el-tag type="success">毕业设计基础框架</el-tag>
        </p>
        <p>
          <el-button
            type="primary"
            ...
            icon="el-icon-cloudy"
            plain
            @click="goTarget('https://spring.io/projects/spring-boot')"
            >Spring Boot</el-button
          >
          <el-button
            size="mini"
            icon="el-icon-s-home"
            plain
            @click="goTarget('https://cn.vuejs.org/')"
            >Vue 文档</el-button
          >
        </p>
      </el-col>
    ...
    <el-row :gutter="20">
      <el-col :xs="24" :sm="24" :md="12" :lg="8">
        <el-card class="update-log">
          ...
          <div class="body">
            <p>
              <i class="el-icon-s-shop"></i> 目标用户：买家、创作者、平台管理员
            </p>
            <p>
              <i class="el-icon-s-order"></i> 核心流程：商品浏览、需求发布、报价沟通、订单成交
            </p>
            <p>
              <i class="el-icon-collection-tag"></i> 特色方向：定制交易、社区互动、个性化推荐
            </p>
            <p>
              <i class="el-icon-data-analysis"></i> 当前阶段：完成管理后台与业务模块骨架
            </p>
          </div>
        </el-card>
      </el-col>
      ...
      <el-col :xs="24" :sm="24" :md="12" :lg="8">
        <el-card class="update-log">
          ...
          <div class="body">
            <p><b>后端：</b> Spring Boot、Spring Security、MyBatis、Redis</p>
            <p><b>前端：</b> Vue2、Vuex、Vue Router、Element UI、Axios</p>
            <p><b>数据库：</b> MySQL 8.0</p>
            <p><b>下一阶段：</b> 完善 CRUD、联通菜单权限、实现特色算法与审核能力</p>
          </div>
        </el-card>
      </el-col>
    </el-row>
